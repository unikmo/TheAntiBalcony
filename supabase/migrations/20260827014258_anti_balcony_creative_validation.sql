...
alter table public.anti_balcony_orders
  ...
  add constraint anti_balcony_orders_creative_duration_check check (
    (creative_content_type like 'video/%' and creative_duration_seconds between 14.5 and 15.5)
    or (creative_content_type like 'image/%' and creative_duration_seconds is null)
  );
